        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    <!-- ++++++++++++++++++++ radioButton 1 : بحث بنوع الفاتورة ++++++++++++++++++++ -->
                    <div class="col-lg-3">
                        <label class="rdiobox">
                    ...
                    <!-- ++++++++++++++++++++ radioButton 2 : بحث برقم الفاتورة ++++++++++++++++++++ -->
                    ...
                    <br><br>
                    <div class="row">
                        <!-- ++++++++++++++++++++ radioButton 1 : تحديد نوع الفواتير ++++++++++++++++++++ -->
                        ...
                        <!--  ++++++++++++++++++ radioButton 2 : البحث برقم الفاتورة ++++++++++++++++++ -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">
                                                {{ $invoice->sectionsRelation->section_name }}
                                            </a>
                                        </td>
...
<script>
    $(document).ready(function() {
        // Hide "invoice_number" inputField
        $('#invoice_number').hide();
        // When Clicking on "radioButton"
        $('input[type="radio"]').click(function()
        {
            // ++++++++++++++++++ radioButton 1 : البحث برقم الفاتورة ++++++++++++++++++
            if ($(this).attr('id') == 'type_div')
            {
                // Hide "invoice_number" inputField
                $('#invoice_number').hide();
                // Show "invoice_type" inputField
                $('#type').show();
                // Show "start_at_date" inputField
                $('#start_at').show();
                // Show "end_at_date" inputField
                $('#end_at').show();
            }
            // ++++++++++++++++++ radioButton 2 : تحديد نوع الفواتير ++++++++++++++++++
            else
            {
                // Show "invoice_number" inputField
                $('#invoice_number').show();
                // Hide "invoice_type" inputField
                $('#type').hide();
                // Hide "start_at_date" inputField
                $('#start_at').hide();
                // Hide "end_at_date" inputField
                $('#end_at').hide();
            }
        });
    });
