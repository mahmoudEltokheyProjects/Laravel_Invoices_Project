            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                        <!-- اضافة فاتورة -->
                        <a href="invoices/create" class="modal-effect btn btn-primary" style="color:white">
                                ...
                                <tbody>
                                    ...
                                    @foreach ( $allInvoices as $invoice )
                                        ...
                                        <tr>
                                            ...
                                            {{-- اسم القسم : لما اضغط عليه هيبعتني علي تفاصيل الفاتورة --}}
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item" href=" {{ url('edit_invoice') }}/{{ $invoice->id }}">
                                                            <i class="text-success fas fa-pen"></i>&nbsp;&nbsp;تعديل الفاتورة
                                                        </a>
                                                        <!-- حذف الفاتورة -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('InvoiceArchiving', 'test') }}" method="post">
                            {{ method_field('Post') }}
                            {{ csrf_field() }}
                    </div>
                    <div class="modal-body">
...
<!-- Appear "invoice_id" in "Delete invoice Modal" -->
<script>
...
<!-- Appear "invoice_id" in "Archive invoice Modal" -->
<script>
