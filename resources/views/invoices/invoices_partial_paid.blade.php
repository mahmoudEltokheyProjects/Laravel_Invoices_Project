...
@section('title') الفواتير المدفوعة جزئياً @stop
@section('css')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير المدفوعة جزئياً</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            <tbody>
                                ...
                                $i = 0;
                                @endphp
                                @foreach ($partialPaidInvoice as $invoice)
                                    @php
                                    $i++
                                    @endphp
                                    <tr>
