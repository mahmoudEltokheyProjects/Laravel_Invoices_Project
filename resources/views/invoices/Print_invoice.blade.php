                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h4>شركة الحمد لتحصيل الديون للبنوك.</h4>
                                <p> 24 شارع صلاح سالم , مدينة نصر , القاهرة , مصر <br>
                                    تليفون : 01237898664<br>
                                    البريد الالكتروني: youremail@companyname.com
                                </p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">تم الدفع الي</label>
                                <div class="billed-to">
                                    <h6>سمير جمال</h6>
                                    <p> 24 شارع صلاح سالم , مدينة نصر , القاهرة , مصر <br>
                                        تليفون : 01237898664<br>
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span>{{ $invoices->sectionsRelation->section_name }}</span>
                                </p>
                            </div>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        // When click on "print" button , Execute The "printDiv()" method
        function printDiv()
        {
